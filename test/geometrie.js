                 ...
                 .send({ geom: geometrie })
                    .expect(res => {
                        ...
                        expect(feature.properties).to.eql({
                            surface_intersection: '0.0133',
                            surface_parcelle: 490.1197406007501,
                            numero: '1220',
                            feuille: 4,
                            section: '0B',
                            code_dep: '07',
