    ...
    request(options, function (error, response, body) {
        if (!error && response.statusCode == 200) {
            ...
            if(response.statusCode == 403){
                if((body.indexOf('MissingRights')) !=-1) {
                    messageError = 'Code erreur 500 : Service indisponible pour votre configuration.';
                } else {messageError = 'Code Erreur 500:Problème d\'accès au service';}
            } 
