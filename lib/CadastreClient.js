...
class CadastreClient {
    ...
    constructor(apiKey, options) {
        ...
        this.serviceUrl = options.serviceUrl || 'https://wxs.ign.fr';
    }
    ...
    getDivisions(params, done) {
        ...
        options.qs.typename = 'BDPARCELLAIRE-VECTEUR_WLD_BDD_WGS84G:divcad';
        options.qs.outputFormat = 'application/json';
        options.qs.cql_filter = cql_filter(params);
    ...
    getCadastreFromGeom(feature, done) {
        ...
        options.qs.outputFormat = 'application/json';
        options.form = {
            cql_filter: cql_filter(paramsGeom)
        };
        options.method = 'POST';
        options.expectedFormat = 'json';
    ...
    getCommune(params, done) {
        const options = this.getDefaultOptions();
        options.qs.request = 'GetFeature';
        options.qs.typename = 'BDPARCELLAIRE-VECTEUR_WLD_BDD_WGS84G:commune';
        options.qs.outputFormat = 'application/json';
        options.qs.cql_filter = cql_filter(params);
        options.expectedFormat = 'json';
    ...
    getLocalisant(params, done) {
        const options = this.getDefaultOptions();
        options.qs.request = 'GetFeature';
        options.qs.typename = 'BDPARCELLAIRE-VECTEUR_WLD_BDD_WGS84G:localisant';
        options.qs.outputFormat = 'application/json';
        options.qs.cql_filter = cql_filter(params);
        options.expectedFormat = 'json';
